...
export default async function GotoMarketHomePage({ params }: Props) {
  const title = "Go-to-Market";
  ...
  const tasks = await Promise.all(
    headerSections
      ...
      .map(async (hs) => ({
        ...
        href: Links.ProjectGoToMarket(params.projectId, hs.slug),
      }))
  );
  ...
  return (
    <HomeContainer
      ...
      feedbackLink={site.feedbackLinks.gotoMarket}
    />
  );
}
